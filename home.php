...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/styles.css"><!-- includes.html -->
    ...
    <nav role="navigation">
        <ul class="navlist">
            <li><a href="home.php" id="techrangers">
                <span id="char1">T</span>
                <span id="char2">E</span>
                <span id="char3">C</span>
                <span id="char4">H</span>
                <span id="char5">R</span>
                <span id="char6">A</span>
                <span id="char7">N</span>
                <span id="char8">G</span>
                <span id="char9">E</span>
                <span id="char10">R</span>
                <span id="char11">S</span>
            </a></li>
 ...
 <!-- header.html -->
	...
	<main role="main" id="homemain">
		...
		<aside role="complementary" id="homeaside">
    <h2>Tutorials</h2>
        <p>Are you as eager to learn as we are? Check out some of our <a href="tutorials.php">tutorials</a>.</p>

        <ol>
            <li><a href="http://ucfcdl.github.io/html5-tutorial/" target="_blank">Introduction to HTML5 and Canvas</a></li>
            <li><a href="techrangers-training.php">Techrangers Training</a></li>
            <li><a href="oauth-python-tutorial.php">OAuth Python Tutorial</a></li>
            <li><a href="a-simple-poll-manager-with-django.php">A Simple Poll Manager With Django</a></li>
            <li><a href="http://ucf.github.io/fuelphp-crash-course/" target="_blank">Fuel Crash Course</a></li>
        </ol>

    <h2>Tech Time</h2>
        <p>Check out our <a href="techtime.php">upcoming Tech Times</a>!</p>
</aside>
 <!-- sidebar.html -->
    ...
    <p>Copyright &copy; 2014, Techrangers&trade; <a href="https://online.ucf.edu/about" target="_blank">Center for Distributed Learning</a></p>

    <div id="socmed">
        <ul>
            <li><a href="https://twitter.com/techrangers" id="twitter" target="_blank"><span>Twitter</span></a></li>
            <li><a href="https://plus.google.com/u/0/100247024936649114253/posts" id="gplus" target="_blank"><span>Google Plus</span></a></li>
            <li><a href="https://www.facebook.com/UCFTechrangers" id="facebook" target="_blank"><span>Facebook</span></a></li>
        </ul>
    </div>
</footer>
 <!-- footer.html -->

	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"2660c64d59","applicationID":"15579828","transactionName":"b1VaMEBYXEVUUE0LV1YfbRZbFlpZWFYXElBI","queueTime":0,"applicationTime":0,"atts":"QxJZRghCT0s=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
