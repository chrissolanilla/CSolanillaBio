        ...
        <section> 
            ...
            <section id="tutorials">
                <section class="tutitem"> 
                	<h1><a href="http://techrangers.cdl.ucf.edu/introduction-to-canvas-html5">Introduction to HTML5 and Canvas</a></h1>
                    <img src="#" alt="Introduction to HTML5 and Canvas" />
                ...
                <section class="tutitem">
                	<h1><a href="http://techrangers.cdl.ucf.edu/techrangers-training">Techrangers Training</a></h1>
                    <img src="#" alt="Techrangers Training" />
                ...
                <section class="tutitem"> 
                	<h1><a href="http://techrangers.cdl.ucf.edu/oauth-python-tutorial">OAuth Python Tutorial</a></h1>
                    <img src="#" alt="OAuth Python Tutorial" />
                ...
                <section class="tutitem"> 
                	<h1><a href="http://techrangers.cdl.ucf.edu/a-simple-poll-manager-with-django">A Simple Poll Manager With Django</a></h1>
                    <img src="#" alt="A Simple Poll Manager With Django" />
                ...
                <section class="tutitem"> 
                	<h1><a href="http://techrangers.cdl.ucf.edu/fuel-crash-course">Fuel Crash Course</a></h1>
                    <img src="#" alt="Fuel Crash Course" />
                    <p>This tutorial is designed to introduce you to the Fuel PHP framework by walking you through the creation of a simple messaging app.</p>
