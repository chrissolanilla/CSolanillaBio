...
<body>
    ...
    <main role="main" id="biomain">
        ...
        <section role="region" class="pagecontent" id="biopage">
            ...
            <section role="region">
            <h1 class="bioh1">Douglas Beck</h1>
        
            	<img src="images/bios/douglas.jpg" alt="Douglas Beck" />
            	
                <h2>Degree:</h2>
                	<p>Computer Science</p>

                <h2>Website:</h2>
                    <p><a href="http://douglasbeck.com/" target="_blank">http://douglasbeck.com/</a></p>
                
                <h2>Roles:</h2>
                	<ul>
                        <li>Techrangers - Assistant Team Lead</li>
                        <li>Future-proof Technology Expert</li>
                    </ul>
